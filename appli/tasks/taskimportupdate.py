...
from appli import db, app, database, ObjectToStr, PrintInCharte, gvp, gvg, EncodeEqualList, DecodeEqualList, ntcv, \
    GetAppManagerMailto, CreateDirConcurrentlyIfNeeded, UtfDiag
...
class TaskImportUpdate(AsyncTask):
    ...
    def GetDoneExtraAction(self):
        ...
        <a href='/Task/Create/TaskClassifAuto2?projid={0}' class='btn btn-primary btn-sm'  role=button>Go to Automatic Classification Screen</a> """.format(PrjId)
