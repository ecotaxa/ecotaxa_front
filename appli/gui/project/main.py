...
@app.route("/gui/prj/LoadRightPane", methods=["GET", "POST"])
def loadRightPane():
    PrjId: str = gvp("projid")
    return loadRightPaneForProj(int(PrjId), False, False)


def loadRightPanelForProj(PrjId: int, read_only: bool, force_first_page: bool):
    # Security & sanity checks
...
<div class='ddet'><span class='ddets'><span class='glyphicon glyphicon-eye-open'></span> {4} {5}</div></td>""".format(
    ...
    html.append(
        render_template(
            "v2/project/vignettes_pane.html",
            data={
...
######################################################################################################################
# noinspection PyPep8Naming
@app.route("/gui/prjGetClassifTab/<int:PrjId>", methods=["GET", "POST"])
def PrjGetClassifTab(PrjId):
    ...
    return render_template(
        "v2/project/classiftab.html", res=restree, taxotree=json.dumps(taxotree)
    )
...
# noinspection PyPep8Naming
@app.route("/gui/prj/GetFieldList/<int:PrjId>/<string:typefield>")
@login_required
...
# import appli.gui.project.index
# noinspection PyUnresolvedReferences
...
# noinspection PyUnresolvedReferences
# import appli.gui.project.objectdetails
# noinspection PyUnresolvedReferences
import appli.gui.project.projectsettings

# noinspection PyUnresolvedReferences
# import appli.gui.project.merge
# noinspection PyUnresolvedReferences
# import appli.gui.project.purge
# noinspection PyUnresolvedReferences
# import appli.gui.project.editannot
# noinspection PyUnresolvedReferences
# import appli.gui.project.editdatamass
# noinspection PyUnresolvedReferences
# import appli.gui.project.taxo_fix
