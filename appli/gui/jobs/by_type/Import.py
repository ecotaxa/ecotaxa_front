                ...
                dict(
                    {
                        ...
                        "data": " data-import=commonserver data-selectunder=Ecotaxa_Data_to_import  data-url=gui/common/ServerFolderSelectJSON data-where=import-server data-tree=commonserver data-target=unique",
                    }
                ),
            ],
            action=cls.ACTION,
