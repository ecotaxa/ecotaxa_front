...
def indexExplore():
    ...
    if gvg("taxo[]"):
        with ApiClient(TaxonomyTreeApi, request) as api:
            categs: List[TaxonModel] = api.query_taxa_set(gvg("taxo[]"))
...
def ExploreLoadRightPane():
    ...
    ret = LoadRightPaneForProj(PrjId=projids, read_only=True, force_first_page=True)
