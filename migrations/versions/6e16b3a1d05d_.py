...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['projid'], ['projects.projid'], ),
    sa.PrimaryKeyConstraint('pprojid')
    )
    op.create_index('is_part_projects_projid', 'part_projects', ['projid'], unique=False)
    op.create_table('part_samples',
    ...
    sa.ForeignKeyConstraint(['pprojid'], ['part_projects.pprojid'], ),
    sa.ForeignKeyConstraint(['sampleid'], ['samples.sampleid'], ),
    sa.PrimaryKeyConstraint('psampleid')
    )
    op.create_index('is_part_samples_prj', 'part_samples', ['pprojid'], unique=False)
    op.create_index('is_part_samples_sampleid', 'part_samples', ['sampleid'], unique=False)
    op.create_table('part_ctd',
    sa.Column('psampleid', sa.INTEGER(), nullable=False),
    ...
    sa.Column('in_situ_density_anomaly', postgresql.DOUBLE_PRECISION(), nullable=True),
    ...
    sa.Column('part_backscattering_coef_470_nm', postgresql.DOUBLE_PRECISION(), nullable=True),
    sa.Column('pot_temperature', postgresql.DOUBLE_PRECISION(), nullable=True),
    sa.Column('potential_density_anomaly', postgresql.DOUBLE_PRECISION(), nullable=True),
    sa.Column('potential_temperature', postgresql.DOUBLE_PRECISION(), nullable=True),
    sa.Column('practical_salinity', postgresql.DOUBLE_PRECISION(), nullable=True),
    sa.Column('practical_salinity__from_conductivity', postgresql.DOUBLE_PRECISION(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['psampleid'], ['part_samples.psampleid'], ),
    sa.PrimaryKeyConstraint('psampleid', 'lineno')
    )
    op.create_table('part_histocat',
    sa.Column('psampleid', sa.INTEGER(), nullable=False),
    ...
    op.create_table('part_histocat_lst',
    sa.Column('psampleid', sa.INTEGER(), nullable=False),
    sa.Column('classif_id', sa.INTEGER(), nullable=False),
    sa.ForeignKeyConstraint(['psampleid'], ['part_samples.psampleid'], ),
    sa.PrimaryKeyConstraint('psampleid', 'classif_id')
    )
    op.create_table('part_histopart_det',
    sa.Column('psampleid', sa.INTEGER(), nullable=False),
    sa.Column('lineno', sa.INTEGER(), nullable=False),
    sa.Column('depth', postgresql.DOUBLE_PRECISION(), nullable=True),
    sa.Column('datetime', postgresql.TIMESTAMP(), nullable=True),
    ...
    op.create_table('part_histopart_reduit',
    sa.Column('psampleid', sa.INTEGER(), nullable=False),
    sa.Column('lineno', sa.INTEGER(), nullable=False),
    sa.Column('depth', postgresql.DOUBLE_PRECISION(), nullable=True),
    sa.Column('datetime', postgresql.TIMESTAMP(), nullable=True),
