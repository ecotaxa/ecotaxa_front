...
def upgrade():
    ...
    op.add_column('collection', sa.Column('short_title', sa.VARCHAR(length=64), nullable=True))
    op.alter_column('collection', 'external_id',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.alter_column('collection', 'external_id_system',
               existing_type=sa.VARCHAR(),
               nullable=False)
