...
# No sample with null orig_id in production DB
...
# No object_field with null orig_id in production DB
cleanup_script = """
begin;
...
def upgrade():
    ...
    op.alter_column('acquisitions', 'orig_id',
               existing_type=sa.VARCHAR(length=255),
               nullable=False)
    op.alter_column('obj_field', 'orig_id',
               existing_type=sa.VARCHAR(length=255),
               nullable=False)
    op.alter_column('process', 'orig_id',
               existing_type=sa.VARCHAR(length=255),
               nullable=False)
    op.alter_column('samples', 'orig_id',
               existing_type=sa.VARCHAR(length=255),
               nullable=False)
