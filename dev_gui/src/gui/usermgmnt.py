...
def dologincreate():
    reCaptchaID = app.config.get('RECAPTCHAID')
    fields = ["firstname", "lastname", "email", "organisation", "country", "password", "usercreationreason"]
    ...
    del posted["lastname"]
    posted["id"] = -1  # Ignored on back-end for anonymous, but needed for model conformance
