...
class PredictionJob(Job):
    ...
    def get_target_project(cls) -> Tuple[Optional[ProjectModel], str]:
        ...
        filters_html = cls.GetFilterText(cls.extract_filters_from_url(filters))
    ...
    def base_projects_select_page(cls):
        ...
        return render_template(
            "v2/jobs/prediction_create_lstproj.html",
    ...
    def final_action(cls, job: JobModel):
        ...
        Go to Manual Classification Screen</a> """.format(
            prj_id
        )
        return ret
    ...
    def validate_task(cls):
        ...
        with ApiClient(ObjectsApi, request) as api:
            filters = {}
            cls.extract_filters_from_url(filters)
    ...
    def categories_config_page(cls):
        ...
        return render_template(
            "v2/jobs/prediction_create_lsttaxo.html",
            url=request.query_string.decode("utf-8"),
            filters_info=filters_html,
    ...
    def features_config_page(cls):
        ...
        return render_template(
            "v2/jobs/prediction_create_settings.html",
            header="",
            data=hidden,
            filters_info=filters_html,
            target_proj=target_proj,
