...
class Constants(object):
    ...
    openapi_types = {
        ...
        'license_restrictions': 'dict(str, str)',
        'access': 'dict(str, str)',
    ...
    def __init__(self, license_texts=None, license_restrictions=None, access=None, app_manager=["",""], countries=[], user_status=None, password_regexp='^(?:(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#?%^&*-+])).{8,20}$', email_verification=True, account_validation=False, short_token_age=1, profile_token_age=24, recaptchaid=False, local_vars_configuration=None):  # noqa: E501
        ...
        self._license_restrictions = None
        self._access = None
        ...
        if license_restrictions is not None:
    ...
    @property
    def license_restrictions(self):
        """Gets the license_restrictions of this Constants.  # noqa: E501

        License sorted by restriction.  # noqa: E501

        :return: The license_restrictions of this Constants.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._license_restrictions

    @license_restrictions.setter
    def license_restrictions(self, license_restrictions):
        """Sets the license_restrictions of this Constants.

        License sorted by restriction.  # noqa: E501

        :param license_restrictions: The license_restrictions of this Constants.  # noqa: E501
        :type: dict(str, str)
        """

        self._license_restrictions = license_restrictions
