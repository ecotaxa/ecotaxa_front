...
individual_volume: 4.0/3.0*math.pi*(math.sqrt(obj.area/math.pi)*ssm.pixel_size)**3''', default_project_access='1', max_upload_size=681574400, time_to_live=None, all_in_one=False, taxoserver_url=None, local_vars_configuration=None):  # noqa: E501
