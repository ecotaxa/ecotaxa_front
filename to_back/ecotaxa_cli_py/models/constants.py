...
individual_volume: 4.0/3.0*math.pi*(math.sqrt(obj.area/math.pi)*ssm.pixel_size)**3''', default_project_access='1', max_upload_size=681574400, time_to_live=None, all_in_one=False, taxoserver_url='https://ecotaxoserver.obs-vlfr.fr/', openid_configured=False, recast_operation=None, local_vars_configuration=None):  # noqa: E501
        ...
        if openid_configured is not None:
            self.openid_configured = openid_configured
    ...
    @property
    def taxoserver_url(self):
        """Gets the taxoserver_url of this Constants.  # noqa: E501

        url of taxonomy server ecotaxoserver  # noqa: E501

        :return: The taxoserver_url of this Constants.  # noqa: E501
        :rtype: str
        """
        return self._taxoserver_url

    @taxoserver_url.setter
    def taxoserver_url(self, taxoserver_url):
        """Sets the taxoserver_url of this Constants.

        url of taxonomy server ecotaxoserver  # noqa: E501

        :param taxoserver_url: The taxoserver_url of this Constants.  # noqa: E501
        :type: str
        """
    ...
    @property
    def openid_configured(self):
        """Gets the openid_configured of this Constants.  # noqa: E501

        Whether OpenID authentication is configured.  # noqa: E501

        :return: The openid_configured of this Constants.  # noqa: E501
        :rtype: bool
        """
        return self._openid_configured

    @openid_configured.setter
    def openid_configured(self, openid_configured):
        """Sets the openid_configured of this Constants.

        Whether OpenID authentication is configured.  # noqa: E501

        :param openid_configured: The openid_configured of this Constants.  # noqa: E501
        :type: bool
        """

        self._openid_configured = openid_configured
