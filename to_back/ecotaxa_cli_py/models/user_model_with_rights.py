...
class UserModelWithRights(object):
    ...
    def __init__(self, id=None, email=None, password=None, name=None, organisation=None, active=None, country=None, usercreationdate=None, usercreationreason=None, can_do=[], last_used_projects=[], local_vars_configuration=None):  # noqa: E501
