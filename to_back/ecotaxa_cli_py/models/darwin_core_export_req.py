...
class DarwinCoreExportReq(object):
    ...
    def __init__(self, collection_id=None, dry_run=False, include_predicted=False, with_absent=False, with_computations=[], extra_xml=[], local_vars_configuration=None):  # noqa: E501
