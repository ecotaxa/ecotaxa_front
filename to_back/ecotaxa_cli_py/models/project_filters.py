...
class ProjectFilters(object):
    ...
    def statusfilter(self, statusfilter):
        ...
        if (self.local_vars_configuration.client_side_validation and
                statusfilter is not None and len(statusfilter) > 3):
            raise ValueError("Invalid value for `statusfilter`, length must be less than or equal to `3`")  # noqa: E501
    ...
    def filt_annot(self):
        ...
        Coma-separated list of annotators, i.e. persons who validated the classification at any point in time.  # noqa: E501
    ...
    def filt_last_annot(self):
        ...
        Coma-separated list of annotators, i.e. persons who validated the classification in last.  # noqa: E501
