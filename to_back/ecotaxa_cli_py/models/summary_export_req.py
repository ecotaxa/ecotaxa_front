...
class SummaryExportReq(object):
    ...
    def __init__(self, project_id=None, quantity=None, summarise_by=None, taxo_mapping=None, formulae=None, out_to_ftp=False, local_vars_configuration=None):  # noqa: E501
