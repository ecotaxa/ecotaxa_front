...
class ExportReq(object):
    ...
    def __init__(self, project_id=None, exp_type=None, use_latin1=False, tsv_entities='', only_annotations=False, split_by='', coma_as_separator=False, format_dates_times=True, with_images=False, with_internal_ids=False, with_types_row=False, only_first_image=False, sum_subtotal=None, pre_mapping=None, formulae=None, out_to_ftp=False, local_vars_configuration=None):  # noqa: E501
