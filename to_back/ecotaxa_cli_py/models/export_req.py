...
class ExportReq(object):
    ...
    openapi_types = {
        ...
        'quantity': 'list[AnyOfExportTypeEnumSummaryExportQuantitiesOptionsEnum]',
    ...
    @property
    def quantity(self):
        """Gets the quantity of this ExportReq.  # noqa: E501

        The quantity to compute. Abundance is always possible.  # noqa: E501

        :return: The quantity of this ExportReq.  # noqa: E501
        :rtype: list[AnyOfExportTypeEnumSummaryExportQuantitiesOptionsEnum]
        """
        return self._quantity

    @quantity.setter
    def quantity(self, quantity):
        """Sets the quantity of this ExportReq.

        The quantity to compute. Abundance is always possible.  # noqa: E501

        :param quantity: The quantity of this ExportReq.  # noqa: E501
        :type: list[AnyOfExportTypeEnumSummaryExportQuantitiesOptionsEnum]
        """
