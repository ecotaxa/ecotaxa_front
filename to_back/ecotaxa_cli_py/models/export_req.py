...
class ExportReq(object):
    ...
    def __init__(self, project_id=None, exp_type=None, tsv_entities=None, split_by=None, coma_as_separator=None, format_dates_times=None, with_images=None, with_internal_ids=None, only_first_image=None, sum_subtotal=None, out_to_ftp=None, local_vars_configuration=None):  # noqa: E501
