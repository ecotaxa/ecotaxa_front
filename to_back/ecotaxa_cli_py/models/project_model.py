...
class ProjectModel(object):
    ...
    def __init__(self, projid=None, title=None, access=None, status=None, objcount=None, pctvalidated=None, pctclassified=None, classifsettings=None, initclassiflist=None, classiffieldlist=None, popoverfieldlist=None, comments=None, rf_models_used=None, cnn_network_id=None, formulae='''subsample_coef: 1/ssm.sub_part
total_water_volume: sam.tot_vol/1000
individual_volume: 4.0/3.0*math.pi*(math.sqrt(obj.area/math.pi)*ssm.pixel_size)**3''', obj_free_cols=None, sample_free_cols=None, acquisition_free_cols=None, process_free_cols=None, init_classif_list=[], managers=[], annotators=[], viewers=[], contact=None, instrument=None, instrument_url=None, highest_right='', local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def access(self):
        """Gets the access of this ProjectModel.  # noqa: E501

        When \"1\" (PUBLIC), the project is visible by all users.PUBLIC: \"1\", OPEN: \"2\", PRIVATE: \"0\"  # noqa: E501

        :return: The access of this ProjectModel.  # noqa: E501
        :rtype: str
        """
        return self._access
    ...
    def access(self, access):
        """Sets the access of this ProjectModel.

        When \"1\" (PUBLIC), the project is visible by all users.PUBLIC: \"1\", OPEN: \"2\", PRIVATE: \"0\"  # noqa: E501

        :param access: The access of this ProjectModel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def formulae(self):
        """Gets the formulae of this ProjectModel.  # noqa: E501

        Concentration formulae.  # noqa: E501

        :return: The formulae of this ProjectModel.  # noqa: E501
        :rtype: str
        """
    ...
    def formulae(self, formulae):
        """Sets the formulae of this ProjectModel.

        Concentration formulae.  # noqa: E501

        :param formulae: The formulae of this ProjectModel.  # noqa: E501
        :type: str
        """
