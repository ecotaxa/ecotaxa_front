...
class TaxaSearchRsp(object):
    ...
    @property
    def status(self):
        """Gets the status of this TaxaSearchRsp.  # noqa: E501

        The taxon/category status, 'D' for Deprecated, 'A' for Approved or 'N' for Not approved.  # noqa: E501

        :return: The status of this TaxaSearchRsp.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this TaxaSearchRsp.

        The taxon/category status, 'D' for Deprecated, 'A' for Approved or 'N' for Not approved.  # noqa: E501

        :param status: The status of this TaxaSearchRsp.  # noqa: E501
        :type: str
        """
