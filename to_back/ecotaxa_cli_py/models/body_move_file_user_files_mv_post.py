...
class BodyMoveFileUserFilesMvPost(object):
    ...
    def __init__(self, source_path=None, dest_path=None, local_vars_configuration=None):  # noqa: E501
        """BodyMoveFileUserFilesMvPost - a model defined in OpenAPI"""  # noqa: E501
    ...
    def source_path(self):
        ...
        The client-side full path of the file, files list , files filter or directory to be moved.  # noqa: E501
    ...
    def dest_path(self):
        ...
        The client-side full path of the destination file, destination files or directory.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BodyMoveFileUserFilesMvPost):
            return False
