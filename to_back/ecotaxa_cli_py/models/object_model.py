...
class ObjectModel(object):
    ...
    def __init__(self, classif_when=None, classif_auto_id=None, classif_auto_score=None, classif_auto_when=None, objid=None, acquisid=None, classif_who=None, classif_id=None, objtime=None, latitude=None, longitude=None, depth_min=None, depth_max=None, objdate=None, classif_qual=None, sunpos=None, classif_score=None, orig_id=None, object_link=None, complement_info=None, sample_id=None, project_id=None, images=[], free_columns=None, classif_crossvalidation_id=None, similarity=None, random_value=None, local_vars_configuration=None):  # noqa: E501
