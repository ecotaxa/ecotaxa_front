...
class MyFilesApi(object):
    ...
    def create_user_file(self, **kwargs):  # noqa: E501
        ...
        **Create a new file or directory in the current user files directory.** The returned text will contain a server-side path which is usable for some file-related operations.  # noqa: E501
        ...
        return self.create_user_file_with_http_info(**kwargs)  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method create_user_file" % key
                )
    ...
    def move_user_file(self, **kwargs):  # noqa: E501
        ...
        **Move (or rename depending on source and dest path) a file or directory in the current user files directory.** The returned text will contain a server-side path which is usable for some file-related operations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.move_user_file(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.move_user_file_with_http_info(**kwargs)  # noqa: E501

    def move_user_file_with_http_info(self, **kwargs):  # noqa: E501
        """Move User File  # noqa: E501

        **Move (or rename depending on source and dest path) a file or directory in the current user files directory.** The returned text will contain a server-side path which is usable for some file-related operations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.move_user_file_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def remove_user_file(self, **kwargs):  # noqa: E501
        ...
        **Remove a file, or directory in the current user files directory.**  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.remove_user_file_with_http_info(**kwargs)  # noqa: E501

    def remove_user_file_with_http_info(self, **kwargs):  # noqa: E501
        """Remove User File  # noqa: E501

        **Remove a file, or directory in the current user files directory.**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_user_file_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method remove_user_file" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
