...
class AdminApi(object):
    ...
    def db_direct_query(self, q, **kwargs):  # noqa: E501
        ...
        :param str q: The SQL to execute. (required)
        ...
        return self.db_direct_query_with_http_info(q, **kwargs)  # noqa: E501

    def db_direct_query_with_http_info(self, q, **kwargs):  # noqa: E501
        """Direct Db Query  # noqa: E501

        For making selects on the DB. 🔒 Admin only.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.db_direct_query_with_http_info(q, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('q' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `q` when calling `db_direct_query`")  # noqa: E501
