...
class TaxonomyTreeApi(object):
    ...
    def add_worms_taxon(self, add_worms_taxon_model, **kwargs):  # noqa: E501
        """Add Worms Taxon  # noqa: E501

        Add worms taxon by its aphia_id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_worms_taxon(add_worms_taxon_model, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param AddWormsTaxonModel add_worms_taxon_model: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.add_worms_taxon_with_http_info(add_worms_taxon_model, **kwargs)  # noqa: E501

    def add_worms_taxon_with_http_info(self, add_worms_taxon_model, **kwargs):  # noqa: E501
        """Add Worms Taxon  # noqa: E501

        Add worms taxon by its aphia_id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_worms_taxon_with_http_info(add_worms_taxon_model, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'add_worms_taxon_model' is set
        if self.api_client.client_side_validation and ('add_worms_taxon_model' not in local_var_params or  # noqa: E501
                                                        local_var_params['add_worms_taxon_model'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `add_worms_taxon_model` when calling `add_worms_taxon`")  # noqa: E501
        ...
        body_params = None
        if 'add_worms_taxon_model' in local_var_params:
            body_params = local_var_params['add_worms_taxon_model']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def get_taxonomy_recast(self, target_id, **kwargs):  # noqa: E501
        """Get Taxonomy Recast  # noqa: E501

        **Read the collection or project taxonomy recast**.  Note: The data is returned only if manageable.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_taxonomy_recast(target_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: TaxoRecastRsp
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.get_taxonomy_recast_with_http_info(target_id, **kwargs)  # noqa: E501

    def get_taxonomy_recast_with_http_info(self, target_id, **kwargs):  # noqa: E501
        """Get Taxonomy Recast  # noqa: E501

        **Read the collection or project taxonomy recast**.  Note: The data is returned only if manageable.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_taxonomy_recast_with_http_info(target_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(TaxoRecastRsp, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_taxonomy_recast" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('target_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `target_id` when calling `get_taxonomy_recast`")  # noqa: E501
        ...
        if 'is_collection' in local_var_params and local_var_params['is_collection'] is not None:  # noqa: E501
            query_params.append(('is_collection', local_var_params['is_collection']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TaxoRecastRsp',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_taxonomy_worms(self, **kwargs):  # noqa: E501
        """Get Taxonomy Worms  # noqa: E501

        **Read the collection or project taxonomy recast**.  Note: The data is returned only if manageable.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_taxonomy_worms(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_taxonomy_worms_with_http_info(**kwargs)  # noqa: E501

    def get_taxonomy_worms_with_http_info(self, **kwargs):  # noqa: E501
        """Get Taxonomy Worms  # noqa: E501

        **Read the collection or project taxonomy recast**.  Note: The data is returned only if manageable.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_taxonomy_worms_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_taxonomy_worms" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def search_taxonomy_recast(self, operation, **kwargs):  # noqa: E501
        """Search Taxonomy Recast  # noqa: E501

        **Among given project_ids, return the existing taxonomy recast records for the given operation**, each enriched with its project title. Note: only administered/readable projects are considered. If project_ids is not given, all projects readable/administered by the current user are considered.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_taxonomy_recast(operation, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param RecastOperation operation: One of RecastOperation enum value (required)
        :param str project_ids: Project ids to check, separated by ,. If not given, all projects readable/administered by the current user are considered.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: list[TaxoRecastSearchRsp]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.search_taxonomy_recast_with_http_info(operation, **kwargs)  # noqa: E501

    def search_taxonomy_recast_with_http_info(self, operation, **kwargs):  # noqa: E501
        """Search Taxonomy Recast  # noqa: E501

        **Among given project_ids, return the existing taxonomy recast records for the given operation**, each enriched with its project title. Note: only administered/readable projects are considered. If project_ids is not given, all projects readable/administered by the current user are considered.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_taxonomy_recast_with_http_info(operation, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[TaxoRecastSearchRsp], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_taxonomy_recast" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('operation' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `operation` when calling `search_taxonomy_recast`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[TaxoRecastSearchRsp]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def update_taxonomy_recast(self, taxonomy_recast_req, **kwargs):  # noqa: E501
        """Update Taxonomy Recast  # noqa: E501

        **Create or Update the collection or project taxonomy recast**.  Note: The recast is updated only if manageable.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_taxonomy_recast(taxonomy_recast_req, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param TaxonomyRecastReq taxonomy_recast_req: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_taxonomy_recast_with_http_info(taxonomy_recast_req, **kwargs)  # noqa: E501

    def update_taxonomy_recast_with_http_info(self, taxonomy_recast_req, **kwargs):  # noqa: E501
        """Update Taxonomy Recast  # noqa: E501

        **Create or Update the collection or project taxonomy recast**.  Note: The recast is updated only if manageable.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_taxonomy_recast_with_http_info(taxonomy_recast_req, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_taxonomy_recast" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'taxonomy_recast_req' is set
        if self.api_client.client_side_validation and ('taxonomy_recast_req' not in local_var_params or  # noqa: E501
                                                        local_var_params['taxonomy_recast_req'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `taxonomy_recast_req` when calling `update_taxonomy_recast`")  # noqa: E501
        ...
        body_params = None
        if 'taxonomy_recast_req' in local_var_params:
            body_params = local_var_params['taxonomy_recast_req']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def wormsification_taxa_set(self, ids, **kwargs):  # noqa: E501
        """Wormsification Taxa Set  # noqa: E501

        Returns **information about several taxa**, including their lineage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wormsification_taxa_set(ids, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: dict(str, TaxonModel)
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.wormsification_taxa_set_with_http_info(ids, **kwargs)  # noqa: E501

    def wormsification_taxa_set_with_http_info(self, ids, **kwargs):  # noqa: E501
        """Wormsification Taxa Set  # noqa: E501

        Returns **information about several taxa**, including their lineage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.wormsification_taxa_set_with_http_info(ids, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(dict(str, TaxonModel), status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method wormsification_taxa_set" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'ids' is set
        if self.api_client.client_side_validation and ('ids' not in local_var_params or  # noqa: E501
                                                        local_var_params['ids'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ids` when calling `wormsification_taxa_set`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='dict(str, TaxonModel)',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
