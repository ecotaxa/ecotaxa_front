...
class TaxonomyTreeApi(object):
    ...
    def search_worms_name(self, name, extended, **kwargs):  # noqa: E501
        """Search Worms Name  # noqa: E501

        Information about a single taxon in WoRMS reference, including its lineage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_worms_name(name, extended, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str name: (required)
        :param bool extended: By default Marine only is searched. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.search_worms_name_with_http_info(name, extended, **kwargs)  # noqa: E501

    def search_worms_name_with_http_info(self, name, extended, **kwargs):  # noqa: E501
        """Search Worms Name  # noqa: E501

        Information about a single taxon in WoRMS reference, including its lineage.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_worms_name_with_http_info(name, extended, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'extended' is set
        if self.api_client.client_side_validation and ('extended' not in local_var_params or  # noqa: E501
                                                        local_var_params['extended'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `extended` when calling `search_worms_name`")  # noqa: E501
