...
class CollectionsApi(object):
    ...
    def darwin_core_format_export(self, collection_id, dry_run, with_zeroes, auto_morpho, with_computations, **kwargs):  # noqa: E501
        ...
        **Export the collection in Darwin Core format, e.g. for EMODnet portal**, @see https://www.emodnet-ingestion.eu  Produces a DwC-A (https://dwc.tdwg.org/) archive into a temporary directory, ready for download.  Maybe useful, a reader in Python: https://python-dwca-reader.readthedocs.io/en/latest/index.html  🔒 *For admins only.*  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.darwin_core_format_export_with_http_info(collection_id, dry_run, with_zeroes, auto_morpho, with_computations, **kwargs)  # noqa: E501

    def darwin_core_format_export_with_http_info(self, collection_id, dry_run, with_zeroes, auto_morpho, with_computations, **kwargs):  # noqa: E501
        """Emodnet Format Export  # noqa: E501

        **Export the collection in Darwin Core format, e.g. for EMODnet portal**, @see https://www.emodnet-ingestion.eu  Produces a DwC-A (https://dwc.tdwg.org/) archive into a temporary directory, ready for download.  Maybe useful, a reader in Python: https://python-dwca-reader.readthedocs.io/en/latest/index.html  🔒 *For admins only.*  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.darwin_core_format_export_with_http_info(collection_id, dry_run, with_zeroes, auto_morpho, with_computations, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DarwinCoreExportRsp, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('collection_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `collection_id` when calling `darwin_core_format_export`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('dry_run' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `dry_run` when calling `darwin_core_format_export`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('with_zeroes' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `with_zeroes` when calling `darwin_core_format_export`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('auto_morpho' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `auto_morpho` when calling `darwin_core_format_export`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('with_computations' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `with_computations` when calling `darwin_core_format_export`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/collections/{collection_id}/export/darwin_core', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='DarwinCoreExportRsp',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
