...
class CollectionsApi(object):
    ...
    def search_collection_collections_search_get(self, title, **kwargs):  # noqa: E501
        """Search Collection  # noqa: E501

        Search for collections.  *Currently only for admins*  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_collection_collections_search_get(title, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.search_collection_collections_search_get_with_http_info(title, **kwargs)  # noqa: E501

    def search_collection_collections_search_get_with_http_info(self, title, **kwargs):  # noqa: E501
        """Search Collection  # noqa: E501

        Search for collections.  *Currently only for admins*  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_collection_collections_search_get_with_http_info(title, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_collection_collections_search_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('title' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `title` when calling `search_collection_collections_search_get`")  # noqa: E501
