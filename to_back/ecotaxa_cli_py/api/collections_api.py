...
class CollectionsApi(object):
    ...
    def create_collection(self, dry_run, create_collection_req, **kwargs):  # noqa: E501
        ...
        **Create a collection** with at least one project inside.  Returns the created collection Id.  Note: 'manage' right is required on all underlying projects.  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.create_collection_with_http_info(dry_run, create_collection_req, **kwargs)  # noqa: E501

    def create_collection_with_http_info(self, dry_run, create_collection_req, **kwargs):  # noqa: E501
        """Create Collection  # noqa: E501
        ...
        **Create a collection** with at least one project inside.  Returns the created collection Id.  Note: 'manage' right is required on all underlying projects.  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('dry_run' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `dry_run` when calling `create_collection`")  # noqa: E501
