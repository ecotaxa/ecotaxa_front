...
class ObjectsApi(object):
    ...
    def predict_object_set_0(self, request_body, **kwargs):  # noqa: E501
        """Query Object Set Predictions  # noqa: E501

        ** Return last prediction information for a set of objects, by their IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.predict_object_set_0(request_body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.predict_object_set_0_with_http_info(request_body, **kwargs)  # noqa: E501

    def predict_object_set_0_with_http_info(self, request_body, **kwargs):  # noqa: E501
        """Query Object Set Predictions  # noqa: E501

        ** Return last prediction information for a set of objects, by their IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.predict_object_set_0_with_http_info(request_body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method predict_object_set_0" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'request_body' is set
        if self.api_client.client_side_validation and ('request_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['request_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request_body` when calling `predict_object_set_0`")  # noqa: E501
