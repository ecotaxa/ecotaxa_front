...
class ProjectsApi(object):
    ...
    def list_projects(self, **kwargs):  # noqa: E501
        ...
        :param str order_field: One of ['projid', 'title', 'visible', 'access', 'status', 'objcount', 'pctvalidated', 'pctclassified', 'classifsettings', 'classiffieldlist', 'popoverfieldlist', 'comments', 'description', 'rf_models_used', 'cnn_network_id', 'formulae', 'instrument', 'instrument_url', 'highest_right']
