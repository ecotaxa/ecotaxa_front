...
class AuthentificationApi(object):
    ...
    def login_login_post(self, username, password, **kwargs):  # noqa: E501
        """Login  # noqa: E501

        Just for description. The _real_ login is done in legacy code via flask.  # noqa: E501
        ...
        return self.login_login_post_with_http_info(username, password, **kwargs)  # noqa: E501

    def login_login_post_with_http_info(self, username, password, **kwargs):  # noqa: E501
        """Login  # noqa: E501

        Just for description. The _real_ login is done in legacy code via flask.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.login_login_post_with_http_info(username, password, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('username' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `username` when calling `login_login_post`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('password' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `password` when calling `login_login_post`")  # noqa: E501
